...
function createBerlin() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:10054 --caname ca-berlin --tls.certfiles "${PWD}/organizations/fabric-ca/berlin/tls-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-10054-ca-berlin.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-10054-ca-berlin.pem
    OrganizationalUnitIdentifier: peer
  ...
  infoln "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:10054 --caname ca-berlin -M "${PWD}/organizations/peerOrganizations/berlin.universidades.com/peers/peer0.berlin.universidades.com/msp" --csr.hosts peer0.berlin.universidades.com --tls.certfiles "${PWD}/organizations/fabric-ca/berlin/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer0-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:10054 --caname ca-berlin -M "${PWD}/organizations/peerOrganizations/berlin.universidades.com/peers/peer0.berlin.universidades.com/tls" --enrollment.profile tls --csr.hosts peer0.berlin.universidades.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/berlin/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:8054 --caname ca-berlin -M "${PWD}/organizations/peerOrganizations/berlin.universidades.com/users/User1@berlin.universidades.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/berlin/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://berlinadmin:berlinadminpw@localhost:10054 --caname ca-berlin -M "${PWD}/organizations/peerOrganizations/berlin.universidades.com/users/Admin@berlin.universidades.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/berlin/tls-cert.pem"
  { set +x; } 2>/dev/null
